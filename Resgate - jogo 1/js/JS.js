function start() { // Inicio da função start()
	...
	$("#fundoGame").append("<div id='soldado' class='soldado'></div>");
    ...
    function moveJogador() {
        ...
        function colisao() {
            ...
            var colisao5 = ($("#jogador").collision($("#soldado")));
            var colisao6 = ($("#inimigo2").collision($("#soldado")));
        ...
        function explosao3(soldadoX,soldadoY) {
            $("#fundoGame").append("<div id='explosao3' class='anima4'></div");
            $("#explosao3").css("top",soldadoY);
            $("#explosao3").css("left",soldadoX);
        ...
        function reposicionaSoldado() {
            ...
            var tempoSoldado=window.setInterval(reposiciona6, 6000);
                ...
                $("#fundoGame").append("<div id='soldado' class='anima3'></div>");
	...
	function gameOver() {
        ...
        $("#fim").html("<h1> Game Over </h1><p>Sua pontuação foi: " + pontos + "</p>" + "<div id='reinicia' onClick=reiniciaJogo()><h3>Jogar Novamente</h3><p>Clique Aqui!!</p></div>");
